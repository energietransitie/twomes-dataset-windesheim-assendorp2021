...
- remove statistic outliers, i.e. measurement values with an absolute [z-score](https://en.wikipedia.org/wiki/Standard_score) higher than the value indicated in the `Sigma` column in the table below;
